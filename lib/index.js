...
const HapiAttemptsLimiter = function (server, options, next) {
    ...
    const _newLimit = function (options) {
        const limit = options.limit || settings.global.limit;
        const duration = options.duration || settings.global.duration;
    ...
    const _updateLimit = function (id, options, callback) {
    ...
    server.ext('onPreResponse', function (request, reply) {
        ...
        _updateLimit(request.info.remoteAddress + ':' + request.url.path, options, function (err, limit) {
